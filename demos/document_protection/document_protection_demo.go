...
func demoDocumentProtection() {
	...
	// 启用只读保护
	if err := protection.EnableProtection(wordprocessingml.ReadOnlyProtection, "password123"); err != nil {
	...
	// 添加文本水印
	if err := protection.AddWatermark("机密文档", "机密", wordprocessingml.TextWatermark); err != nil {
	...
	// 添加Logo水印
	if err := protection.AddWatermark("公司Logo", "公司名称", wordprocessingml.LogoWatermark); err != nil {
	...
	// 切换到注释保护
	if err := protection.EnableProtection(wordprocessingml.CommentsProtection, "password123"); err != nil {
	...
	// 切换到跟踪更改保护
	if err := protection.EnableProtection(wordprocessingml.TrackChangesProtection, "password123"); err != nil {
	...
	protection.Encryption.Settings.Algorithm = wordprocessingml.AES256Algorithm

...
func demoAdvancedStyleSystem() {
    ...
    // 创建高级样式系统
    styleSystem := word.NewAdvancedStyleSystem()
    ...
    // 创建字符样式
    emphasisStyle := &word.CharacterStyleDefinition{
        ID:             "Emphasis",
        Name:           "Emphasis",
    ...
    strongStyle := &word.CharacterStyleDefinition{
        ID:             "Strong",
        Name:           "Strong",
        BasedOn:        "DefaultParagraphFont",
        Link:           "",
    ...
    tableStyle := &word.TableStyleDefinition{
        ...
        Properties: &word.TableStyleProperties{
            ...
            AllowOverlap: false,
            AllowBreak:   true,
            Borders: &word.TableBorders{
                Top:     word.BorderSide{Style: "single", Size: 1, Color: "000000"},
                ...
                InsideH: word.BorderSide{Style: "single", Size: 1, Color: "000000"},
                InsideV: word.BorderSide{Style: "single", Size: 1, Color: "000000"},
            },
        },
    }
    ...
    // 尝试添加同名样式（冲突）
    conflictStyle := &word.ParagraphStyleDefinition{
        ID:             "Normal",
        Name:           "Normal",
        BasedOn:        "",
        Next:           "Normal",

...
func TestDocumentBuilder(t *testing.T) {
	...
	builder := wordprocessingml.NewDocumentBuilder()
	...
	doc, err := builder.
		...
		WithProtection(wordprocessingml.ReadOnlyProtection, "password123").
...
func TestParagraphBuilder(t *testing.T) {
	...
	builder := wordprocessingml.NewParagraphBuilder()
...
func TestTableBuilder(t *testing.T) {
	// Test table builder
	builder := wordprocessingml.NewTableBuilder()
...
func TestFluentDocument(t *testing.T) {
	...
	fluentDoc := wordprocessingml.NewFluentDocument(doc)

...
func TestCreateHeader(t *testing.T) {
	...
	if header.Type != wordprocessingml.HeaderType {
		t.Errorf("Expected header type %d, got %d", wordprocessingml.HeaderType, header.Type)
	}
}
...
func TestCreateFooter(t *testing.T) {
	...
	if footer.Type != wordprocessingml.FooterType {
		t.Errorf("Expected footer type %d, got %d", wordprocessingml.FooterType, footer.Type)
	}
}
...
func TestSetCellBorders(t *testing.T) {
	...
	borders := wordprocessingml.CellBorders{
		Top: wordprocessingml.BorderSide{
			Style: "single",
			Size:  4,
			Color: "000000",
		},
